...
const FALLBACK_MENU: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '🛡️', label: 'Zero Trust', route: '/admin/security', adminOnly: true },
      { icon: '📋', label: 'Sự kiện bảo mật', route: '/admin/security-events', adminOnly: true },
      { icon: '🖥️', label: 'Phiên hoạt động', route: '/admin/security-sessions', adminOnly: true },
      {
        icon: '🔍',
        label: 'Đánh giá mối đe dọa',
