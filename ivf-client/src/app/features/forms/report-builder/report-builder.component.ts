...
export class ReportBuilderComponent implements OnInit {
  ...
  configReport(report: ReportTemplate) {
    this.router.navigate(['/forms/reports', report.id, 'config']);
  }

  designReport(report: ReportTemplate) {
    this.router.navigate(['/forms/reports', report.id, 'designer']);
  }
