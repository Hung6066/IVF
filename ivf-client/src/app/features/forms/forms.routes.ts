...
export const FORMS_ROUTES: Routes = [
  ...
  },
  {
    path: 'fill/:id',
    loadComponent: () =>
      import('./form-renderer/form-renderer.component').then((m) => m.FormRendererComponent),
  },
  {
    path: 'chat/:id',
    loadComponent: () =>
      import('./form-conversational/form-conversational.component').then(
        (m) => m.FormConversationalComponent,
      ),
  },
  {
  ...
  },
  {
    path: 'responses',
    loadComponent: () =>
      import('./form-responses/form-responses.component').then((m) => m.FormResponsesComponent),
  },
  {
    path: 'responses/:id',
    loadComponent: () =>
      import('./form-response-detail/form-response-detail.component').then(
        (m) => m.FormResponseDetailComponent,
      ),
  },
  {
    path: 'reports',
