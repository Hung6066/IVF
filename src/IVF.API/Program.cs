...
try
{
    ...
    builder.Services.AddSingleton<IVF.API.Services.TenantCertificateService>();
    builder.Services.AddHostedService<IVF.API.Services.CertAutoRenewalService>();
    builder.Services.AddHostedService<IVF.API.Services.TenantCertLifecycleService>();
